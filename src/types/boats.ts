...
export interface BoatOrder {
  ...
  payMethods?: string[]
  // ФОП для кожного обраного способу (метод → fopId): онлайн — хто приймає гроші і видає чек;
  // 'cod' — ФОП-відправник ТТН (на нього приходить наложений платіж).
  payFops?: Record<string, string>
