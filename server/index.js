...
const CHAT_SYSTEM = [
  ...
  'ВАЖЛИВО: клієнт, який пише в цьому чаті, ВЖЕ на зв\'язку з нами — НЕ відповідай «зв\'яжіться з нами» чи «зверніться до нас». Коли клієнт хоче ВІДДАТИ КОРАБЛИК У СЕРВІС / оформити ремонт (питає «як відправити», «хочу здати в ремонт» тощо) — коротко поясни процес: кораблик надсилають Новою Поштою до нашого сервісу, ми проводимо діагностику й узгоджуємо кошторис, після ремонту надсилаємо назад. І ЗАПРОПОНУЙ оформити заявку на сервіс: постав wantsServiceRequest=true (у месенджері ми автоматично додамо посилання на оформлення; у веб-чаті є кнопка «Оформити заявку на ремонт»). Не ескалюй на менеджера лише через бажання оформити заявку.',
